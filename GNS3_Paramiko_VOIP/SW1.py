...
remote_connection.send("ip dhcp snooping vlan 5\n")
...
remote_connection.send("switchport trunk allowed vlan 5,100\n")
...
remote_connection.send("switchport access vlan 5\n")
